...
func (m *MockTodoList) Update(userId, listId int, input model.UpdateListInput) error {
	m.ctrl.T.Helper()
...
// Update mocks base method.
func (m *MockTodoItem) Update(userId, listId int, input model.UpdateItemInput) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", userId, listId, input)
	ret0, _ := ret[0].(error)
	return ret0
